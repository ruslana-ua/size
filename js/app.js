(() => {
    var __webpack_modules__ = {
        ...
        833: (module, __unused_webpack_exports, __webpack_require__) => {
            "use strict";
            var qs = __webpack_require__(379).qs;
        ...
        646: (module, __unused_webpack_exports, __webpack_require__) => {
            ...
            var event = __webpack_require__(379).B;
            var css = __webpack_require__(379).iv;
            var add = __webpack_require__(379).IH;
            var has = __webpack_require__(379).e$;
            var rm = __webpack_require__(379).rm;
            var clone = __webpack_require__(379).d9;
            var qs = __webpack_require__(379).qs;
            var _baron = baron;
            ...
            baron.version = "3.0.1";
            baron.prototype.autoUpdate = __webpack_require__(431)(scopedWindow);
            baron.prototype.fix = __webpack_require__(367);
            baron.prototype.controls = __webpack_require__(833);
 ...
 */
    ...
    (() => {
        ...
        var core = __webpack_require__(646);
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                if (formRequiredItem.dataset.required === "email") {
                    ...
                    formRequiredItem.value = formRequiredItem.value.replace(" ", "");
                    if (this.textareaTest(formRequiredItem)) {
                        this.addError(formRequiredItem);
                        error++;
                    } else this.removeError(formRequiredItem);
            ...
            phoneTest(formRequiredItem) {
                return !/^.*\d{10,20}$/.test(formRequiredItem.value);
            },
            nameTest(formRequiredItem) {
                return !/[a-zA-Zа-яА-ЯА-ЩЬЮЯҐЄІЇа-щьюяґєії]{2}$/.test(formRequiredItem.value);
            },
            textareaTest(formRequiredItem) {
                return !/[a-zA-Zа-яА-ЯА-ЩЬЮЯҐЄІЇа-щьюяґєії]{10}$/.test(formRequiredItem.value);
            }
        };
        ...
        function initSliders() {
            var sliders = document.querySelectorAll(".tabs__slider");
            if (sliders) sliders.forEach((function(slider) {
                new swiper_core_Swiper(slider, {
                    modules: [ Navigation, Grid, freeMode, Mousewheel ],
                    observer: true,
                    observeParents: true,
                    spaceBetween: 0,
                    speed: 800,
            ...
            if (document.querySelector(".models-popup__slider")) new swiper_core_Swiper(".models-popup__slider", {
                ...
                pagination: {
                    el: ".models-popup__swiper-pagination",
                    clickable: true,
                    renderBullet: function(index, className) {
                        var titleHtml = document.querySelector(".models-popup__slide:nth-child(" + (index + 1) + ") .models-popup__title").innerHTML;
                        return '<span class="' + className + '">' + titleHtml + "</span>";
                    },
                ...
                on: {
                    slideChange: function() {
                        ...
                        if (activeBullet) {
                            var container = document.querySelector(".models-popup__swiper-pagination");
                            Array.from(activeBullet.parentNode.children).indexOf(activeBullet);
                            var newPosition = activeBullet.offsetLeft - container.clientWidth / 2 + activeBullet.clientWidth / 2;
                            container.scrollTo({
                                left: newPosition,
                                behavior: "smooth"
                            });
            ...
            var quickOrderSlider = document.querySelector(".quick-order__slider");
            if (quickOrderSlider) new swiper_core_Swiper(quickOrderSlider, {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                on: {
                    init: function(swiper) {
                        const allSlides = document.querySelector(".quick-order__fraction--all");
                        const allSlidesItems = document.querySelectorAll(".quick-order__slide:not(.swiper-slide-duplicate)");
                        allSlides.innerHTML = allSlidesItems.length.toString();
                    },
                    slideChange: function(swiper) {
                        const currentSlide = document.querySelector(".quick-order__fraction--current");
                        currentSlide.innerHTML = (swiper.realIndex + 1).toString();
                    }
                }
            });
            var formSliders = document.querySelectorAll(".form__slider");
            if (formSliders) {
                var currentSwipers = [];
                function initSwiper(sliderElement) {
                    return new swiper_core_Swiper(sliderElement, {
                        modules: [ Navigation, freeMode, Mousewheel ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 5,
                        ...
                        loop: true,
                        navigation: {
                            prevEl: ".form__swiper-button-prev",
                            nextEl: ".form__swiper-button-next"
                        },
                        freeMode: {
                            enabled: true,
                            sticky: false,
                ...
                function initSwipers() {
                    formSliders.forEach((function(formSlider, index) {
                        var screenWidth = window.innerWidth;
                        if (screenWidth >= 767.98 && !currentSwipers[index]) currentSwipers[index] = initSwiper(formSlider);
                        if (screenWidth < 767.98 && currentSwipers[index]) {
                            destroySwiper(currentSwipers[index]);
                            currentSwipers[index] = null;
                        }
                    }));
                }
                initSwipers();
            ...
            if (document.querySelector(".filters__slider")) new swiper_core_Swiper(".filters__slider", {
                modules: [ Navigation, freeMode, Mousewheel ],
                observer: true,
                observeParents: true,
                spaceBetween: 10,
            ...
            var productGallerySlider = document.querySelector(".product-gallery__slider");
            if (productGallerySlider) {
                var productGallerySwiper;
                function initProductGallerySwiper() {
                    return new swiper_core_Swiper(productGallerySlider, {
                        modules: [ Pagination ],
                        observer: true,
                        observeParents: true,
                        spaceBetween: 10,
                ...
                function destroyProductGallerySwiper() {
                    if (productGallerySwiper) productGallerySwiper.destroy(true, true);
                }
                function initProductGallerySwiperIfNeeded() {
                    var screenWidth = window.innerWidth;
                    if (screenWidth <= 991.98 && !productGallerySwiper) productGallerySwiper = initProductGallerySwiper();
                    if (screenWidth > 991.98 && productGallerySwiper) {
                        destroyProductGallerySwiper();
                        productGallerySwiper = null;
                    }
                }
                initProductGallerySwiperIfNeeded();
                window.addEventListener("resize", (function() {
                    initProductGallerySwiperIfNeeded();
                }));
            }
            var sizeTabsSlider = document.querySelectorAll(".size-tabs__slider");
            if (sizeTabsSlider) sizeTabsSlider.forEach((function(slider) {
                new swiper_core_Swiper(slider, {
        ...
        function asideScroll() {
            ...
            if (windowWidth < 1386) {
                addWindowScrollEvent = true;
                const header = document.querySelector(".filters__top");
                if (header) {
                    const headerShow = header.hasAttribute("data-scroll-show");
                    const headerShowTimer = header.dataset.scrollShow ? header.dataset.scrollShow : 500;
                    const startPoint = header.dataset.scroll ? header.dataset.scroll : 1;
...
***************************************************************************** */
        ...
        const deliveryInputs = document.querySelectorAll(".delivery-order__input");
        if (deliveryInputs) deliveryInputs.forEach((deliveryInput => {
            const clearInputBtn = deliveryInput.closest(".delivery-order__form").querySelector(".delivery-order__clear");
            if (deliveryInput && clearInputBtn) {
                function clearInput() {
                    deliveryInput.value = "";
                    clearInputBtn.classList.remove("visible");
                }
                deliveryInput.addEventListener("input", (() => {
                    const inputValue = deliveryInput.value.trim().toLowerCase();
                    clearInputBtn.classList.add("visible");
                    if (!inputValue) return;
                }));
                clearInputBtn.addEventListener("click", clearInput);
        ...
        var productСontent = document.querySelectorAll(".product__content");
        if (productСontent) document.addEventListener("DOMContentLoaded", (function() {
            var addButtons = document.querySelectorAll(".product__add");
            addButtons.forEach((function(addButton) {
                addButton.addEventListener("mouseenter", (function() {
                    var productWrap = this.parentElement;
                    productWrap.classList.add("show");
                }));
            }));
            var productWraps = document.querySelectorAll(".product__wrap");
            productWraps.forEach((function(productWrap) {
                var isClickedOnSize = false;
                productWrap.addEventListener("mouseleave", (function() {
                    if (!isClickedOnSize) productWrap.classList.remove("show");
                    isClickedOnSize = false;
                }));
                productWrap.addEventListener("click", (function(event) {
                    if (event.target.classList.contains("product__size")) {
                        isClickedOnSize = true;
                        var productWrap = event.target.parentElement.parentElement;
                        event.target.classList.add("add");
                        productWrap.classList.add("added");
                        setTimeout((function() {
        ...
        if (productRow) {
            document.addEventListener("DOMContentLoaded", (function() {
                var favoriteButtons = document.querySelectorAll(".product__favorite");
        ...
        var productPage = document.querySelector(".product-page__fix");
        if (productPage) {
        ...
        function moveElementsBasedOnScreenSize() {
            ...
            items.forEach((item => {
                const priceElement = item.querySelector(".cart-list__price");
                const buttonElement = item.querySelector(".cart-list__button");
                const screenSizeCondition = window.matchMedia("(max-width: 767.98px)");
                ...
                function movePriceToBlock() {
                    const blockElement = item.querySelector(".cart-list__block");
                    blockElement.insertBefore(priceElement, blockElement.firstChild);
                }
                function movePriceToTop() {
                    const topElement = item.querySelector(".cart-list__top");
                    topElement.appendChild(priceElement);
                }
                function moveButtonToEnd() {
                    const topElement = item.querySelector(".cart-list__top");
                    topElement.appendChild(buttonElement);
                }
                function moveButtonToTop() {
                    const contentElement = item.querySelector(".cart-list__content");
                    contentElement.appendChild(buttonElement);
                }
                handleScreenSizeChange(screenSizeCondition);
                screenSizeCondition.addListener(handleScreenSizeChange);
            }));
        }
        if (cartList) {
            document.addEventListener("DOMContentLoaded", moveElementsBasedOnScreenSize);
            window.addEventListener("resize", moveElementsBasedOnScreenSize);
        }
        var orderCheckout = document.querySelector(".order-checkout");
        if (orderCheckout) {
            function isMobileScreen() {
                return window.innerWidth < 991.98;
            }
            function moveBlockInItem(item) {
                const price = item.querySelector(".order-checkout__price");
                const content = item.querySelector(".order-checkout__content");
                if (isMobileScreen()) content.appendChild(price); else {
                    const originalParent = item.querySelector(".order-checkout__top");
                    originalParent.appendChild(price);
                }
            }
            function handleResizeForAllItems() {
                const items = document.querySelectorAll(".order-checkout__item");
                items.forEach((item => {
                    moveBlockInItem(item);
                }));
            }
            window.addEventListener("resize", handleResizeForAllItems);
            handleResizeForAllItems();
        }
        ...
        window.addEventListener("DOMContentLoaded", (event => {
            if (urlHash) {
                ...
                setTimeout((function() {
                    ...
                    const urlPosition = window.pageYOffset + urlTarget.getBoundingClientRect().top - heightMin;
                    window.scroll({
                        top: urlPosition,
                        behavior: "smooth"
                    });
        ...
        var popupQuickOrder = document.querySelector(".popup--quick_order");
        if (popupQuickOrder) document.addEventListener("afterPopupOpen", (function(e) {
            moveElementsBasedOnScreenSize();
            console.log("js moveElementsBasedOnScreenSize запущен");
            initSliders();
            console.log("js initSliders запущен");
            var iconButtons = document.querySelectorAll(".product__icon");
            if (iconButtons) iconButtons.forEach((function(button) {
                button.addEventListener("click", (function() {
                    copyProductCode(button);
                    console.log("js copyProductCode запущен");
                }));
            }));
        }));
        window["FLS"] = false;
